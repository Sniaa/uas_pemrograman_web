          ...
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                ...
                <button type="button" class="btn btn-primary"><a href="buku/tambah_data.php">Tambah Data</a></button>
                  <thead>
                    <tr>
                ...
                $no = 1;
                $tampil = mysqli_query($koneksi, "SELECT b.*,p.nama_penulis,pn.nama_penerbit,k.nama_kategori
                FROM buku b
                LEFT JOIN penulis p ON b.kode_penulis = p.kode_penulis
                ...
                <?php while ($data = mysqli_fetch_array($tampil)) : ?>
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-success" href="buku/edit.php?kode_buku=<?=$data['kode_buku'];?>" onclick="return confirm('Apakah Anda yakin ingin mengubah')";>Edit</a>
                      <a class="btn btn-danger" href="buku/hapus.php?kode_buku=<?=$data['kode_buku'];?>" onclick="return confirm('Apakah Anda yakin')";>hapus</a>
                    </td>
                  </tr>
                  <?php endwhile; ?>
              </tbody>
